...
router.post('/mailer',async(req,res)=>{
    ...
    let User = await model.Userinfo.findOne({"userlogin.userEmail":req.body.userlogin.userEmail});  //checking emailid
     ...
     let transporter = nodemailer.createTransport({
        ...
        let mailOptions = {
            from:'"SuperMarkeT.in" <darshprajapati.krb@gmail.com>', // sender address
            to: User.userlogin.UserEmail, //list of receivers
            subject:'Reset Your Password',  // subject line :smile:
            text:'open this link to change your password http://localhost:4200/updatepassword' + token // plain text body
        };
